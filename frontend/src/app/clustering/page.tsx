  ...
  return (
    <div className="space-y-4">
      ...
      <div className="glass-4 p-4 rounded-2xl flex flex-col sm:flex-row gap-4 items-start sm:items-center">
        ...
        <input type="number" className="bg-transparent border border-white/20 rounded-xl border border-white/20 p-2 w-24" value={k} onChange={e=>setK(+e.target.value)} />
        <button className="px-3 py-2 rounded-xl border border-white/20 bg-white/10 hover:bg-white/20">Proses</button>
      </div>
